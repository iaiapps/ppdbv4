        ...
        <div class="table-responsive">
            <table id="table" class="table table-bordered rounded">
                ...
                <tbody>
                    ...
                    <tr>
                        <td>Jumlah</td>
                        <td>@currency($student->cost_category->gedung + $student->cost_category->perpustakaan + $student->cost_category->kegiatan + $student->cost_category->bukumedia + $student->cost_category->seragam + $student->cost_category->jilbab + $student->cost_category->ipp)
                        </td>
                    </tr>
